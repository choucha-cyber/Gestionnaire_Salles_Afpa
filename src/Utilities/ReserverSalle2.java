...
public class ReserverSalle2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReserverSalle2 frame = new ReserverSalle2();
	...
	public  ReserverSalle2() {
		...
		//btn1M.addActionListener((event)-> System.out.println("btn Salle 1 matin cliqué")) ;
		
		
		btn1M.setBounds(307, 230, 190, 29);
		btn1M.setBackground(new Color(0, 153, 0));
		getContentPane().add(btn1M);
		btn1M.addMouseListener(new MouseListener() {
			...
			public void mousePressed(MouseEvent e) {
				// TODO Auto-generated method stub
				btn1M.setBackground(Color.GREEN);
			}
			
			@Override
			public void mouseExited(MouseEvent e) {
				// TODO Auto-generated method stub
				btn1M.setForeground(Color.BLACK);
			}
			
			@Override
			public void mouseEntered(MouseEvent e) {
				// TODO Auto-generated method stub
				btn1M.setForeground(Color.RED);
		...
		labelConfirmation.setBounds(224, 585, 720, 76);
		...
		logo_afpa.setIcon(new ImageIcon(ReserverSalle2.class.getResource("/Images/logo_afpa.jpeg")));
		...
		ValiderResa.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				textPane.setBounds(264, 557, 133, 16);
				...
				labelConfirmation.setText("réservation : étage n° " + spinner.getValue() + " en date du :  " + dateString
						+ " confirmée pour la Salle n° ");
				
				//+ ((JButton)event.getSource()).toString()
					...
					if( ((JButton)event.getSource()).getText().equals("btn1M")) {
						...
						lblNewLabel_2.setText("Salle 1, matin");
						
						
						
					}
						else if ( ((JButton)event.getSource()).getText().equals("btn1A")) {
							System.out.println(" Salle 1, après-midi ");
		...
		SalleDispo.setBounds(0, 632, 205, 29);
		getContentPane().add(SalleDispo);
		
		JLabel lblNewLabel_1 = new JLabel("Salle(s) réservées :");
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setBounds(68, 531, 150, 53);
		getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setBounds(256, 526, 241, 39);
