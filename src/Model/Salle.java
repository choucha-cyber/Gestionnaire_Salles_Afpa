...
public class Salle {
		...
		public Salle(int etage, int numSalle) {
			super();
			this.etage = etage;
		...
		public Salle(int etage, int numSalle, boolean disponible) {
			super();
			this.etage = etage;
			this.numSalle = numSalle;
		...
		public Salle(int id, int etage, int numSalle, boolean disponible) {
			super();
			this.id = id;
			this.etage = etage;
			this.numSalle = numSalle;
